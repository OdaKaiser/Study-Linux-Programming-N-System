...
{   
    ...
    int sharedmem_fd = shm_open(MEM_OBJ_NAME,  O_RDWR, 0666);//creating a shared mem fd
    ...
    char *data = (char *)mmap(0, sharedMemSize, PROT_READ | PROT_WRITE, MAP_SHARED, sharedmem_fd, 0);
